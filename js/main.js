...
$App.NAB.PageID = "Base";
$scope.PushButton50_click = function() {$scope.GotoPage( "Main" );};
$scope.G_change = function() {localStorage.setItem("M016x001",$App.M016x001);};
...
$scope.Prompt07_click = function() {$scope.GotoPage( "SelectionM006x01" );};
$scope.Line07_click = function() {$scope.ObjectToFront("Short07");};
$scope.Line08_click = function() {$scope.ObjectToFront("Short08");};
$scope.LetterB_click = function() {$scope.GotoPage( "SelectionM002x01" );};
$scope.LetterC_click = function() {$scope.GotoPage( "SelectionM003x01" );};
$scope.LetterE_click = function() {$scope.GotoPage( "SelectionM005x01" );};
$scope.LetterD_click = function() {$scope.GotoPage( "SelectionM004x01" );};
$scope.LetterF_click = function() {$scope.GotoPage( "SelectionM006x01" );};
$scope.LetterG_click = function() {$scope.GotoPage( "SelectionM007x01" );};
$scope.LetterH_click = function() {$scope.GotoPage( "SelectionM008x01" );};
$scope.LetterH_mouseenter = function() {$scope.ObjectToFront("Prompt08");};
$scope.PushButton9_click = function() {$scope.GetObjectXY("Circlea","possa1","possa2");
$scope.GetObjectXY("Circleb","possb1","possb2");
$scope.GetObjectXY("Circlec","possc1","possc2");
$scope.GetObjectXY("Circled","possd1","possd2");
$scope.GetObjectXY("Circlee","posse1","posse2");
$scope.GetObjectXY("Circlef","possf1","possf2");
$scope.GetObjectXY("Circleg","possg1","possg2");
$scope.GetObjectXY("Circleh","possh1","possh2");
$scope.MoveObject("Circlea",$App.possb1,$App.possb2);
$scope.MoveObject("Circleb",$App.possa1,$App.possa2);
$scope.MoveObject("Circlec",$App.possd1,$App.possd2);
$scope.MoveObject("Circled",$App.possc1,$App.possc2);
$scope.MoveObject("Circlee",$App.possf1,$App.possf2);
$scope.MoveObject("Circlef",$App.posse1,$App.posse2);
$scope.MoveObject("Circleh",$App.possg1,$App.possg2);
$scope.MoveObject("Circleg",$App.possh1,$App.possh2);
$App.possa1 = $scope.Calculate($App.possa1+"+0",-1);
$App.possa2 = $scope.Calculate($App.possa2+"+0",-1);
$App.possb1 = $scope.Calculate($App.possb1+"+0",-1);
$App.possb2 = $scope.Calculate($App.possb2+"+0",-1);
$App.possc1 = $scope.Calculate($App.possc1+"+0",-1);
$App.possc2 = $scope.Calculate($App.possc2+"+0",-1);
$App.possd1 = $scope.Calculate($App.possd1+"+0",-1);
$App.possd2 = $scope.Calculate($App.possd2+"+0",-1);
$App.posse1 = $scope.Calculate($App.posse1+"+0",-1);
$App.posse2 = $scope.Calculate($App.posse2+"+0",-1);
$App.possf1 = $scope.Calculate($App.possf1+"+0",-1);
$App.possf2 = $scope.Calculate($App.possf2+"+0",-1);
$App.possg1 = $scope.Calculate($App.possg1+"+0",-1);
$App.possg2 = $scope.Calculate($App.possg2+"+0",-1);
$App.possh1 = $scope.Calculate($App.possh1+"+0",-1);
$App.possh2 = $scope.Calculate($App.posseh+"+0",-1);
$App.Circlec = "Circlec";
$scope.MoveObject($App.Circlec,$App.possf1,$App.possf2);};
$scope.LetterA_click = function() {$scope.GotoPage( "SelectionM001x01" );};
$scope.PushButton121_click = function() {$scope.MoveObject("Circlea",$App.possa1,$App.possa2);
$scope.MoveObject("Circleb",$App.possb1,$App.possb2);
$scope.MoveObject("Circlec",$App.possc1,$App.possc2);
$scope.MoveObject("Circled",$App.possd1,$App.possd2);
$scope.MoveObject("Circlee",$App.posse1,$App.posse2);
$scope.MoveObject("Circlef",$App.possf1,$App.possf2);
$scope.MoveObject("Circleg",$App.possg1,$App.possg2);
$scope.MoveObject("Circleh",$App.possh1,$App.possh2);};
$scope.PushButton36_click = function() {$App.level01 = 117.46875;
$App.level02 = 138.8628125;
$App.level03 = 160.1875;
$App.level04 = 181.546875;
$App.level05 = 202.90625;
$App.level06 = 224.265625;
$App.level07 = 245,625;
$App.level08 = 266.96975;
$scope.GetObjectXY("Line01","zleft","z1");
$scope.GetObjectXY("Line02","zleft","z2");
$scope.GetObjectXY("Line03","zleft","z3");
$scope.GetObjectXY("Line04","zleft","z4");
$scope.GetObjectXY("Line05","zleft","z5");
$scope.GetObjectXY("Line06","zleft","z6");
$scope.GetObjectXY("Line07","zleft","z7");
$scope.GetObjectXY("Line08","zleft","z8");
$App.z1 = $scope.Calculate($App.z1+"-20",-1);
$App.z2 = $scope.Calculate($App.z2+"-20",-1);
$App.z3 = $scope.Calculate($App.z3+"-20",-1);
$App.z4 = $scope.Calculate($App.z4+"-20",-1);
$App.z5 = $scope.Calculate($App.z5+"-20",-1);
$App.z6 = $scope.Calculate($App.z6+"-20",-1);
$App.z7 = $scope.Calculate($App.z7+"-20",-1);
$App.z8 = $scope.Calculate($App.z8+"-20",-1);
$scope.MoveObject("Line01",$App.zleft,$App.z1);
$scope.MoveObject("Line02",$App.zleft,$App.z2);
$scope.MoveObject("Line03",$App.zleft,$App.z3);
$scope.MoveObject("Line04",$App.zleft,$App.z4);
$scope.MoveObject("Line05",$App.zleft,$App.z5);
$scope.MoveObject("Line06",$App.zleft,$App.z6);
$scope.MoveObject("Line07",$App.zleft,$App.z7);
$scope.MoveObject("Line08",$App.zleft,$App.z8);};
$scope.PushButton122_click = function() {$scope.GetObjectXY("Line01","zleft","z1");
$scope.GetObjectXY("Line02","zleft","z2");
$scope.GetObjectXY("Line03","zleft","z3");
$scope.GetObjectXY("Line04","zleft","z4");
$scope.GetObjectXY("Line05","zleft","z5");
...
$App.level08 = 266.96975;
if ($App.z8 > 270) {
$scope.MoveObject("Line08",$App.zleft,$App.level01);
} else {
};
if ($App.z7 > 270) {
$scope.MoveObject("Line07",$App.zleft,$App.level01);
} else {
};
if ($App.z6 > 270) {
$scope.MoveObject("Line06",$App.zleft,$App.level01);
} else {
};
if ($App.z5 > 270) {
$scope.MoveObject("Line05",$App.zleft,$App.level01);
} else {
};
if ($App.z4 > 270) {
$scope.MoveObject("Line04",$App.zleft,$App.level01);
} else {
};
if ($App.z3 > 270) {
$scope.MoveObject("Line03",$App.zleft,$App.level01);
} else {
};
if ($App.z2 > 270) {
$scope.MoveObject("Line02",$App.zleft,$App.level01);
} else {
};
if ($App.z1 > 270) {
$scope.MoveObject("Line01",$App.zleft,$App.level01);
} else {
};};
...
$scope.HideObject("redg","",0);
$scope.HideObject("redh","",0);};
$scope.PushButton124_click = function() {$scope.HideObject("reda","",0);};
...
$scope.PushButton131_click = function() {$scope.ShowObject("reda","",0);};
...
$scope.TextArea15_change = function() {localStorage.setItem("M003x006",$App.M003x006);};
